...
public class ChatMeServer {
	...
	public final static int SIGN_OUT_REQUEST = 2;
	public final static int UPDATE_ONLINE_USERS_REQUEST = 3;
	
	public final static int GET_BIO_REQUEST = 9;
	public final static int SET_BIO_REQUEST = 10;
	
	public final static int NEW_GROUP_REQUEST = 4;
	public final static int END_GROUP_REQUEST = 5;
	public final static int UPDATE_GROUP_REQUEST = 6;

	public final static int NEW_PRIVATE_REQUEST = 8;

	public final static int NEW_GROUP_MESSAGE_REQUEST = 20;
	public final static int NEW_PRIVATE_MESSAGE_REQUEST = 7;
